...
Reference: https://github.com/adafruit/Adafruit_Learning_System_Guides/blob/main/Adafruit_STEMMA_Audio_Amp/CircuitPython/code.py
    https://learn.adafruit.com/stemma-audio-amp/circuitpython
"""
import time
import array
import math
...
# Increase this to increase the volume of the tone: 0.1 - 1
#tone_volume = 0.1
tone_volume = 0.5
...
# Middle C Scale: C, D, etc
tone_frequency = [262, 294, 330, 349, 392, 440, 494, 523] 
