# From: https://github.com/bsatrom/notecard-pico/blob/main/src/lib/adafruit_bme680.py
# From: https://www.hackster.io/brandonsatrom/adding-cellular-to-the-raspberry-pi-pico-b8a4b6
